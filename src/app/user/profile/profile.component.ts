...
export class ProfileComponent implements OnInit {
  ...
  // randomly assigning some orders to delivery partner as said in problem statement
  ...
  isLoggedInDelivery: boolean = this._delivery.isLoggedIndelivery;
  ...
  ngOnInit(): void {
    this.isLoggedInDelivery = this._delivery.isLoggedIndelivery
  ...
  logout(){
    ...
    window.localStorage.removeItem("nophe");
